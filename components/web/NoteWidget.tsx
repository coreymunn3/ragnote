  ...
  return (
    <>
      <Link href={noteUrl} className="block w-full h-full">
        <Card
          variant="dense"
          className={`${pinned && "bg-primary/10 border border-primary"} ${!pinned && "min-w-[250px]"} cursor-pointer hover:shadow-md hover:text-primary hover:border hover:border-primary transition-all duration-200`}
        >
          {/* Note Widget Header */}
          <CardHeader>
